...
class FillDatabaseUseCase(private val appConfig: BaseConfig,
                          ...
                          private val playersRepository: PlayersRepository) : UseCase<Void?, Boolean>(appConfig) {
